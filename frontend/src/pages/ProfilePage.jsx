...
import { User, Target, Zap, Mail, ShieldCheck, ChevronRight, Save, Trash2, Dumbbell } from 'lucide-react';

export default function NextLevelProfile() {
    // 1. Manage form state the "React Way"
                ...
                <header className="flex flex-col md:flex-row items-center gap-8 mb-16">
                    <div className="relative group">
                        ...
                        <div className="relative w-32 h-32 bg-slate-800 rounded-[2rem] flex items-center justify-center border border-slate-700 shadow-2xl">
                            <span className="text-4xl font-black bg-gradient-to-br from-emerald-400 to-cyan-400 bg-clip-text text-transparent uppercase">
                    ...
                    <aside className="lg:col-span-4 space-y-6">
                        <div className="bg-slate-800/40 backdrop-blur-xl border border-white/5 p-8 rounded-[2.5rem] shadow-2xl">
                            ...
                            <div className="space-y-6">
                                <StatRow icon={<Target className="text-emerald-400" />} label="Goal" value={formData.fitnessGoal} />
                                <StatRow icon={<Zap className="text-amber-400" />} label="Experience" value="Intermediate" />
                                <div className="pt-6 mt-6 border-t border-slate-700/50">
                                    <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-3 text-center md:text-left">Connected Email</p>
                        ...
                        <div className="bg-gradient-to-br from-emerald-600 to-teal-700 p-8 rounded-[2.5rem] text-white shadow-xl relative overflow-hidden group">
                            ...
                            <p className="text-emerald-100/80 text-sm mb-6">Unlock 120+ custom workout templates.</p>
                            <button className="bg-white text-emerald-900 px-6 py-2 rounded-xl text-xs font-black transition-transform active:scale-95">
                                View Benefits
                            </button>
                        </div>
                    </aside>
                        ...
                        <div className="bg-slate-800/40 backdrop-blur-xl border border-white/5 p-8 md:p-12 rounded-[2.5rem] shadow-2xl">
                            <div className="flex items-center gap-4 mb-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-400 text-sm font-medium">Update your training parameters</p>
                                </div>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                ...
                                <div className="pt-8 flex flex-col sm:flex-row gap-4">
                                    ...
                                    <button
                                        type="button"
                                        onClick={handleReset}
                                        className="px-8 py-4 rounded-2xl border border-slate-700 hover:bg-slate-700/50 font-bold transition-all text-slate-300 flex items-center justify-center gap-2"
                                    >
...
function InputField({ label, ...props }) {
    return (
        <div className="space-y-2">
            ...
            <input
                {...props}
                className="w-full bg-slate-900/50 border border-slate-700 rounded-2xl px-5 py-4 text-white font-semibold focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500/40 transition-all"
            />
        </div>
    );
}
